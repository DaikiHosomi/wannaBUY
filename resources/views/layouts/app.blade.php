                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a href="{{ route('posts.index') }}" class="dropdown-item">掲示板ページ</a>
                                    <a href="{{ route('posts.create') }}" class="dropdown-item">掲示板で投稿する</a>
                                    <a href="{{ route('products.index') }}" class="dropdown-item">商品ページ</a>
