    ...
    <div class="card">
        <div class="card-body">
           ...
           <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                     ...
                     <div class="product product-image card-body mb-4">
                        ...
                        <div class="card-body">
                            <div class="form-group form-row">
                                <label for="productImage" class="col-lg-3 col-form-label text-lg-right">画像1</label>
                                <div class="col-lg-8">
                ...
                <div class="product product-option card-body my-4 mx-5">
                ...
                <div class="product product-text card-body my-4 mx-5">
